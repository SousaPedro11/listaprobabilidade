\documentclass[a4paper, 10pt, oneside]{book} %book, article ou report
...
\fancyhead[LO]{\textsl{\uppercase{Variável\ Aleatória\ Discreta}}}
...
\fancypagestyle{cap2}{
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\textsl{\uppercase{Modelos\ de\ Probabilidade\ Discretos}}}
...
\fancypagestyle{cap3}{
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\textsl{\uppercase{Variável\ Aleatória\ Contínua}}}
...
\fancypagestyle{cap4}{
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\textsl{\uppercase{Modelos\ de\ Probabilidade\ Contínuos}}}
