\documentclass[a4paper, 11pt]{article} %book, article ou report
...
\fancyhead[RE]{\textsl{1.\hspace{1ex}NÚMEROS\ REAIS\ E\ COORDENADAS\ NA\ RETA}}
\fancyfoot{}
}
...
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\textsl{\rightmark}}
\fancyhead[RE]{\textsl{2.\hspace{1ex}EQUAÇÕES E GRÁFICOS}}
\fancyfoot{}
}
\include{listings}
